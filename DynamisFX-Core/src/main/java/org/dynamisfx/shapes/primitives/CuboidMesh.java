...
public class CuboidMesh extends TexturedMesh {
    ...
    private final DoubleProperty width = MeshProperty.createDouble(
            DEFAULT_WIDTH, () -> mesh, this::updateMesh);
    ...
    private final DoubleProperty height = MeshProperty.createDouble(
            DEFAULT_HEIGHT, () -> mesh, this::updateMesh);
    ...
    private final DoubleProperty depth = MeshProperty.createDouble(
            DEFAULT_DEPTH, () -> mesh, this::updateMesh);
    ...
    private final IntegerProperty level = MeshProperty.createInteger(
            DEFAULT_LEVEL, () -> mesh, this::updateMesh);
