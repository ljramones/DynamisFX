...
import org.dynamisfx.shapes.primitives.helper.SpringHelper;
...
public class SpringMesh extends TexturedMesh {
    ...
    private final DoubleProperty meanRadius = MeshProperty.createDouble(
            DEFAULT_MEAN_RADIUS, () -> mesh, this::updateMesh);
