...
public class LightningDemo extends ParticleFieldDemoBase {

    @Override
    protected ParticleFieldConfiguration createConfiguration() {
        return ParticleFieldFactory.lightningStrike();
    }

    @Override
    public String getSampleDescription() {
        return "Lightning strike with fractal branching path.";
    }
}
