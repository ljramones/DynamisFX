...
public class MagicAuraDemo extends ParticleFieldDemoBase {

    @Override
    protected ParticleFieldConfiguration createConfiguration() {
        return ParticleFieldFactory.healingAura();
    }

    @Override
    public String getSampleDescription() {
        return "Healing aura with gentle outward green-gold spiral.";
    }
}
