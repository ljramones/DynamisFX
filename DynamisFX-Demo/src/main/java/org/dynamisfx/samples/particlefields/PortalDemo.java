...
public class PortalDemo extends ParticleFieldDemoBase {

    @Override
    protected ParticleFieldConfiguration createConfiguration() {
        return ParticleFieldFactory.mysticPortal();
    }

    @Override
    public String getSampleDescription() {
        return "Mystic portal with inward spiraling blue-purple particles.";
    }
}
