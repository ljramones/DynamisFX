...
public class SmokeDemo extends ParticleFieldDemoBase {

    @Override
    protected ParticleFieldConfiguration createConfiguration() {
        return ParticleFieldFactory.campfireSmoke();
    }

    @Override
    public String getSampleDescription() {
        return "Campfire smoke rising with wide spread and turbulence.";
    }
}
