...
class FXyzClientResourceTest {
    ...
    void formatMethodsResolveBundledTemplates() throws Exception {
        ...
        Method formatSource = FXyzClient.class.getDeclaredMethod("formatSourceCode", org.fxyz3d.FXyzSample.class);
        formatSource.setAccessible(true);
        String sourceHtml = (String) formatSource.invoke(client, sample);

        Method formatCss = FXyzClient.class.getDeclaredMethod("formatCss", org.fxyz3d.FXyzSample.class);
