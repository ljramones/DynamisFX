...
import org.fxyz3d.collision.Aabb;
import org.fxyz3d.collision.CollisionDebugSnapshot3D;
import org.fxyz3d.collision.CollisionEvent;
import org.fxyz3d.collision.CollisionPair;
import org.fxyz3d.collision.CollisionWorld3D;
import org.fxyz3d.collision.NodeCollisionAdapter;
import org.fxyz3d.collision.SweepAndPrune3D;
...
public class CollisionDebugWorld extends ShapeBaseSample<Group> {
    ...
    private void spawnBody(
        ...
        box.setTranslateY(y);
        box.setTranslateZ(z);
        NodeCollisionAdapter.setFilter(box, org.fxyz3d.collision.CollisionFilter.DEFAULT);
        bodies.add(box);
    ...
    private void renderFrame(List<CollisionEvent<Node>> events) {
        ...
        for (CollisionEvent<Node> event : events) {
            if (event.type() != org.fxyz3d.collision.CollisionEventType.EXIT) {
